...
-- Records of t_score
-- ----------------------------
INSERT INTO `t_score` VALUES (1, 4, 55, 34, 66, 55, 55, 55, '');
INSERT INTO `t_score` VALUES (2, 2, 11, 55, 55, 77, 88, 99, '');
INSERT INTO `t_score` VALUES (3, 9, 22, 69, 33, 44, 55, 66, 'dauhdia');

-- ----------------------------
-- Table structure for t_score_old
-- ----------------------------
DROP TABLE IF EXISTS `t_score_old`;
CREATE TABLE `t_score_old`  (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `student_id` int(5) NOT NULL,
  `course_id` int(5) NOT NULL,
  ...
  CONSTRAINT `t_score_old_ibfk_1` FOREIGN KEY (`course_id`) REFERENCES `t_course` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `t_score_old_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `t_student` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 70 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_score_old
-- ----------------------------
INSERT INTO `t_score_old` VALUES (68, 9, 1, 50.00, '不及格');
INSERT INTO `t_score_old` VALUES (69, 2, 1, 66.00, '');
INSERT INTO `t_score_old` VALUES (70, 4, 1, 88.00, '');
...
-- ----------------------------
INSERT INTO `t_student` VALUES (2, '20160101', '张三', '123456', 1, '男', '13545454548', '1332365656', NULL);
INSERT INTO `t_student` VALUES (4, '20160102', '李四', '123456', 4, '男', '13356565655', '123456', NULL);
INSERT INTO `t_student` VALUES (9, '20160103', '王五1', '123456', 5, '女', '13333332133', '1313131323', 'bb12326f-ef6c-4d3d-a2ae-f9eb30a15ad4.jpg');
...
-- ----------------------------
INSERT INTO `t_teacher` VALUES (9, '199701', '张小', '123456', 1, '男', '13918655656', '1193284480', NULL);
INSERT INTO `t_teacher` VALUES (10, '199702', '李低', '123456', 4, '男', '13656565656', '123456', NULL);
INSERT INTO `t_teacher` VALUES (11, '199703', '李网', '123456', 5, '男', '18989898989', '1456655565', NULL);
INSERT INTO `t_teacher` VALUES (18, '199704', '夏青松', '123456', 6, '女', '15174857845', '1745854125', '5d447b8b-ec54-4a8e-919a-453aa7b6d33b.jpg');
INSERT INTO `t_teacher` VALUES (19, '199705', '李九', '123456', 7, '男', '13111111111', '124545', '61e2d36b-7e63-484f-877e-35202d829a70.pdf');
INSERT INTO `t_teacher` VALUES (21, '199706', 'devil', '12345678', 8, '男', '', '', NULL);
INSERT INTO `t_teacher` VALUES (25, '199710', '小张', '123456', 6, '男', '', '', NULL);
...
-- Records of t_term
-- ----------------------------
INSERT INTO `t_term` VALUES (1, '2015-2016学年第二学期');
